...
<%@ page import="team.ape.epcot.vo.WishlistVo" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/app/assets/css/wishlist/wishlist.css">
...
<div class="tabs w">
    <div class="tab_name">愿望单</div>
</div>

<div class="prolist w ">
    <div class="prolist_left">
        <%
            for (GameVoEntity game : wishlistVo.getGames()) {
            ...
            <div class="proitem_info">
                ...
                <div class="proitem_info_right">
                    ...
                    <div class="proitem_info_right3">
                        <a href="${pageContext.request.contextPath}/wishlist/remove?title=<%= EncoderUtils.base64(game.getTitle()) %>&backUrl="
                           class="need-back-url">
                            <span>移除</span>
                        </a>
                    </div>
