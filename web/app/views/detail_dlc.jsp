...
<%@ page import="team.ape.epcot.vo.DetailDlcVo" %>
...
<%
    ...
    DetailDlcVo detailDlcVo = (DetailDlcVo) request.getAttribute("detailDlcVo");
%>
<html>
<head>
...
<div class="prolist w ">
    <div class="prolist_left" >
        <div class="prolist_main">
            ...
            %>
            <div class="proitem">
                <a href="${pageContext.request.contextPath}/game/detail?title=<%= Base64.encodeBase64URLSafeString(detailDlcVo.getGame().getTitle().getBytes(StandardCharsets.UTF_8)) %>&dlcTitle=<%= Base64.encodeBase64URLSafeString(dlc.getTitle().getBytes(StandardCharsets.UTF_8)) %>">
                    <div class="proimg">
